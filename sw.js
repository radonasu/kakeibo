...
const CACHE_NAME = 'kakeibo-v24.76'; // v24.76: opp-card/ci-event-item/pm-table-row/sb-row/cal-ev-item/dow-table-row/fv-cat-row/ev-widget-item dark mode enhanced inset-left glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
