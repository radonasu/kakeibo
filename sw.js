...
const CACHE_NAME = 'kakeibo-v21.08'; // v21.08: タイポグラフィ改善・5要素のline-heightをlh-tight→lh-tighterに修正（.pt-widget-exp/.debt-widget-pct/.ev-mtot/.ev-cat-badge/.pace-daily-val .pace-unit）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
