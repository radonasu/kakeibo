...
const CACHE_NAME = 'kakeibo-v19.89'; // v19.89: tx-cb/sb-check/ev-done-cb/rc-item transition transform ease-bounce追加（カスタムチェックボックス3種・繰り返し取引アイテムのhover scale/liftアニメーションにバウンスイージング追加）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
