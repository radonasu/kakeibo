...
const CACHE_NAME = 'kakeibo-v23.74'; // v23.74: summary-amount/hm-stat-value/ct-stat-value/tg-stat-value/smi-amount/smi-label/yi-card-label/debt-balance-meta に text-shadow glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
