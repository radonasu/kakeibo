...
const CACHE_NAME = 'kakeibo-v23.75'; // v23.75: cal-ev-amount/dow-stat-label/debt-widget-balance/cat-stat-lbl/hm-stat-sub/cal-ev-badge/dow-label-cell/yi-card-unit に text-shadow glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
