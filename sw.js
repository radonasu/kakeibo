...
const CACHE_NAME = 'kakeibo-v24.32'; // v24.32: asset-entry-balance/cal-ev-name/smi-income-label/smi-expense-label/hs-trend-label/pace-bar-pace-unit/ct-chip-name/summary-label static-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
