...
const CACHE_NAME = 'kakeibo-v24.58'; // v24.58: ev-widget-name/ev-widget-amount/ev-card-amount/ci-event-amount/cat-chip-name/pt-card-yen/debt-rate-badge/hs-item-max dark-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
