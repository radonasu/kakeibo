...
const CACHE_NAME = 'kakeibo-v22.39'; // v22.39: CSS品質改善・lh-tighter→lh-snug＋text-wrap補完6要素（ios-guide-title・ci-score-label・ev-sum-none・ev-cat-badge・yi-card-value-cat・md-cell-label）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
