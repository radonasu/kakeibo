...
const CACHE_NAME = 'kakeibo-v25.02'; // v25.02: insight-title×4 + insight-desc×4 + step-action + wl-card-meta + debt-progress-hdr + debt-progress-detail dark hover text-shadow 12箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
