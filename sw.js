...
const CACHE_NAME = 'kakeibo-v22.71'; // v22.71: デザイン改善・tg-stat-cardホバーglow・tg-table-rowホバー・adv-widget-cardホバー・cc-itemホバー・wk-summary-cellタイプ別glow・wk-bar-colホバー・nt-cardホバーglow（7箇所）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
