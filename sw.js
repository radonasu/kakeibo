...
const CACHE_NAME = 'kakeibo-v24.30'; // v24.30: ci-cell-value-income/expense/positive/negative/goal-monthly-target/debt-rate-badge/tx-month-group-count/step-num static-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
