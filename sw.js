...
const CACHE_NAME = 'kakeibo-v22.28'; // v22.28: CSS品質改善・lh-tighter→lh-snug＋text-wrap補完6要素（cal-panel-cat・cal-panel-mem・cal-ev-cat・csv-format-item・ch-card-meta・recurring-toggle-label）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
