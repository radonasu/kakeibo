...
const CACHE_NAME = 'kakeibo-v22.53'; // v22.53: CSS品質改善・ls-snug→ls-label補完8要素（sidebar-user-email・btn-sm・tx-tag-filter-chip・btn-preset・badge-active・asset-type-badge・cal-dow・memo-cat-hint-btn）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
