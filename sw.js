...
const CACHE_NAME = 'kakeibo-v24.23'; // v24.23: pt-widget-exp＋pt-unit＋wl-archive-date＋wl-archive-price＋opp-saving＋opp-saving-strong＋sb-suggested＋sb-row-td2 static-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
