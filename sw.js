...
const CACHE_NAME = 'kakeibo-v20.00'; // v20.00: タイポグラフィ改善・fs-lg数値表示line-height完備（cal-sum-value/sub-card-amount/pt-card-balance/wl-card-price/ci-score-badge/pm-sum-value 計6要素）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
