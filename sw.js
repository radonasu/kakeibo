...
const CACHE_NAME = 'kakeibo-v22.46'; // v22.46: CSS品質改善・lh-tighter→lh-snug＋text-wrap補完8要素（bulk-sel・adv-filter-sep・adv-preset-chip・smi-filter-badge・month-sel・type-btn・type-toggle-label・badge-active）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
