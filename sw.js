...
const CACHE_NAME = 'kakeibo-v17.84'; // v17.84: スケール4変数＋ブライトネス2変数追加（--scale-btn-active/hover-md/hover-sm/hover-chip・--brightness-hover-mid/press-mid）＋scale9箇所・brightness3箇所変数化
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
