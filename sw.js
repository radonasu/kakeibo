...
const CACHE_NAME = 'kakeibo-v24.43'; // v24.43: ev-sum-inc/ev-sum-exp/sub-cycle-badge/nt-char-count/fc-cell-hint/yi-card-sub/nt-saved-at/cc-amount(type別) static-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
