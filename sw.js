...
const CACHE_NAME = 'kakeibo-v24.89'; // v24.89: budget-item + budget-item-over + btn-ghost + bottom-nav-item + ct-table-row + type-btn-income + type-btn-expense + type-btn dark hover glow enhanced 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
