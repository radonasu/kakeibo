...
const CACHE_NAME = 'kakeibo-v24.93'; // v24.93: btn-share + btn-continue + goal-emoji-btn + ev-emoji-chip + pt-emoji-btn + ch-emoji-btn + adv-filter-toggle + stp-config-summary dark hover text-shadow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
