...
const CACHE_NAME = 'kakeibo-v23.48'; // v23.48: rc-item-name-glow＋debt-name-glow＋asset-name-glow＋pt-card-name-glow＋sub-card-name-glow＋ci-event-name-glow＋opp-title-glow＋ch-card-name-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
