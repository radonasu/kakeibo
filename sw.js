...
const CACHE_NAME = 'kakeibo-v23.68'; // v23.68: md-cat-amount-glow+md-cat-pct-glow+yr-elapsed-badge-glow+nt-char-count-glow+cal-ev-cat-glow+ct-stat-value-sub-glow+cat-yayoi-tag-glow+wl-priority-badge-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
