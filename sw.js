...
const CACHE_NAME = 'kakeibo-v22.34'; // v22.34: CSS品質改善・lh-tighter→lh-snug＋text-wrap補完6要素（summary-label・form-group-label・smi-label・sub-widget-total-label・csv-preview-label・debt-widget-cell-label）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
