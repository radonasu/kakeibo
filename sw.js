...
const CACHE_NAME = 'kakeibo-v23.77'; // v23.77: fv-month-total/sb-banner-lbl/hs-msg/md-cell-balance-pos-value/md-cell-balance-neg-value/opp-saving/asset-balance-delta/sb-diff-pill に text-shadow glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
