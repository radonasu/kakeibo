...
const CACHE_NAME = 'kakeibo-v24.61'; // v24.61: tx-th-sort-active/sub-card-amount/sub-cycle-unit/goal-deadline/goal-note/pm-sum-value/pm-sum-label/pm-sum-sub dark-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
