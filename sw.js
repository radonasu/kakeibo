...
const CACHE_NAME = 'kakeibo-v24.39'; // v24.39: yr-topcat-amt/wk-cell-sub(type別)/ci-score-label/asset-fx-rate/pace-daily-label(status別)/wk-unit(type別)/dw-item-label/sf-chip static-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
