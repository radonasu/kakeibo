...
const CACHE_NAME = 'kakeibo-v22.43'; // v22.43: CSS品質改善・lh-tighter→lh-snug＋text-wrap補完8要素（brand-name・nav-section・api-key-status・supabase-status-pill・notif-badge・bottom-nav-item・step-action・fx-currency-label）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
