...
const CACHE_NAME = 'kakeibo-v23.69'; // v23.69: fc-cell-hint-glow+yi-card-sub-glow+ct-month-cell-glow+ct-cell-val-glow+tx-month-group-count-glow+nt-saved-at-glow+cc-amount-glow+yr-topcat-amt-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
