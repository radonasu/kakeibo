...
const CACHE_NAME = 'kakeibo-v23.52'; // v23.52: dw-item-label-glow＋sb-suggested-glow＋sb-cat-col-glow＋sf-chip-glow＋date-quick-glow＋opp-challenge-glow＋sim-preset-glow＋summary-label-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
