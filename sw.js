...
const CACHE_NAME = 'kakeibo-v23.42'; // v23.42: cal-amount-type-glow＋ev-mtot-type-color＋pace-val-status-color＋cal-sum-type-glow＋yr-value-type-glow＋hm-stat-value-glow＋goal-saved-glow＋debt-balance-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
