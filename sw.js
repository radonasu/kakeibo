...
const CACHE_NAME = 'kakeibo-v24.95'; // v24.95: ci-event-name + opp-title + ch-card-name + pt-urgent-badge + pt-soon-badge + ch-status + yoy-diff + ct-row-total dark hover text-shadow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
