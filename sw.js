...
const CACHE_NAME = 'kakeibo-v25.47'; // v25.47: hm-stat-sub-nth×4+hs-msg+hs-score-num-text-shadow+tg-stat-label+cal-ev-badge-hover+dow-stat-day+hm-stat-unit-nth×3 dark hover 12箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
