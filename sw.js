...
const CACHE_NAME = 'kakeibo-v23.62'; // v23.62: ev-card-name-glow＋ev-card-memo-glow＋ev-cat-badge-glow＋cc-name-glow＋wk-cell-label-glow＋wl-archive-name-glow＋asset-sparkline-label-glow＋ch-widget-label-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
