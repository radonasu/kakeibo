...
const CACHE_NAME = 'kakeibo-v23.54'; // v23.54: bottom-nav-label-glow＋sub-widget-name-glow＋ev-widget-name-glow＋rc-item-meta-glow＋sub-cycle-tag-glow＋sub-card-memo-glow＋cat-chip-name-glow＋memo-cell-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
