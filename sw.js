...
const CACHE_NAME = 'kakeibo-v23.87'; // v23.87: btn-ghost/btn-danger/btn-dark-toggle/btn-icon/btn-preset/card-collapse-btn/btn-share/stp-help-summary に text-shadow glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
