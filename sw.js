...
const CACHE_NAME = 'kakeibo-v21.09'; // v21.09: タイポグラフィ改善・6要素のline-heightをlh-tight→lh-tighterに修正（.cat-chip-name/.tx-sort-badge-x/.sync-cloud-status-ok/.supabase-status-pill/.bottom-nav-item/.goal-dash-pct）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
