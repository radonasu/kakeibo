...
const CACHE_NAME = 'kakeibo-v25.00'; // v25.00: ci-cell-value(income/expense/positive/negative) + pace-daily-val(good/warn/over) + rc-item-meta dark hover text-shadow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
