...
const CACHE_NAME = 'kakeibo-v24.90'; // v24.90: btn-primary + btn-danger + btn-success + modal-close + btn-icon + empty-month-btn + btn-inline-add + goal-emoji-btn dark hover glow enhanced 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
