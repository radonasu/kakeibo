...
const CACHE_NAME = 'kakeibo-v17.33'; // v17.33: size-dot-lg(12px)/size-ev-cb(14px)/size-chip-del(15px)変数追加＋11箇所変換（fc-progress-today/ev-done-cb/sf-chip-del/wk-bar-wrap/fv-seg-bar-mobile/adv-month-badge）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
