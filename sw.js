...
const CACHE_NAME = 'kakeibo-v25.24'; // v25.24: budget-track×1+budget-fill×1+budget-fill.over×1+color-dot×2+budget-pct-badge×2+budget-sep×2+opp-saving×1+opp-saving-strong×1+opp-desc×1 dark hover 12箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
