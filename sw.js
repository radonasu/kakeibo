...
const CACHE_NAME = 'kakeibo-v24.51'; // v24.51: nav-item-not-active/btn-sidebar-logout/btn-account-add/ev-sum-count-small/btn-notif-bell/ci-ok-btn/ev-add-month/tx-tag-filter-chip-not-active static-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
