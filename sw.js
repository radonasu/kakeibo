...
const CACHE_NAME = 'kakeibo-v22.57'; // v22.57: CSS品質改善・ls-snug→ls-fine補完8要素（amount-prefix・budget-cat-name・auth-tab・fx-currency-label・section-tab・goal-dash-name・cal-ev-name・sub-widget-name）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
