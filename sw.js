...
const CACHE_NAME = 'kakeibo-v23.73'; // v23.73: asset-entry-date/asset-entry-note/ev-widget-month/hs-prev-badge/yr-unit/fv-fixed-val/fv-var-val/dow-td3 に text-shadow glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
