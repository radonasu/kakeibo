...
const CACHE_NAME = 'kakeibo-v22.76'; // v22.76: デザイン改善・forecast-cardホバーglow・ci-cell/ci-challenge/ci-event/ci-score-rowホバー・dow-table-rowカラーglow・fc-progress-todayパルス・adv-sk-lineスタガー（8箇所）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
