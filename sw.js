...
const CACHE_NAME = 'kakeibo-v24.94'; // v24.94: notif-toggle-label + recurring-toggle-label + sb-select-all-wrap + rc-item-name + debt-name + asset-name + pt-card-name + sub-card-name dark hover text-shadow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
