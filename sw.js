...
const CACHE_NAME = 'kakeibo-v21.17'; // v21.17: タイポグラフィ改善・57要素のline-heightをlh-tight→lh-tighterに修正（wk-bar-amount/cc/yr/ci/notif/calc/rc/kb/dd/yi/opp/md/pace/pm/cat系）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
