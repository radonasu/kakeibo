...
const CACHE_NAME = 'kakeibo-v22.32'; // v22.32: CSS品質改善・lh-tighter→lh-snug＋text-wrap補完6要素（ch-section-title・hm-stat-label・sim-loan-name・sim-chart-title・notif-toggle-label・yi-card-label）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
