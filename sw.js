...
const CACHE_NAME = 'kakeibo-v23.53'; // v23.53: yr-avg-label-glow＋fv-month-cell-glow＋budget-sep-glow＋pt-unit-glow＋ev-done-label-glow＋debt-history-title-glow＋asset-history-title-glow＋tg-first-col-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
