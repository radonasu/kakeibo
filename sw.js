...
const CACHE_NAME = 'kakeibo-v24.21'; // v24.21: ev-widget-cat＋smi-count＋pt-note＋ev-card-name＋ev-card-memo＋wl-archive-name＋ch-widget-label＋cc-name static-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
