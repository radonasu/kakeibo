...
const CACHE_NAME = 'kakeibo-v24.85'; // v24.85: yoy-summary-item + ct-stat-card + fv-stat-rate + sub-widget-item×3 + pt-widget-item + wish-widget-item hover outer glow dark mode enhanced 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
