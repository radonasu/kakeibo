...
const CACHE_NAME = 'kakeibo-v23.66'; // v23.66: ev-card-amount-glow＋ev-prog-pct-glow＋wl-archive-price-glow＋pt-card-yen-glow＋pt-exp-badge-glow＋debt-entry-balance-glow＋pm-text-muted-glow＋cal-date-num-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
