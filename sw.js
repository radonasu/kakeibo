...
const CACHE_NAME = 'kakeibo-v21.53'; // v21.53: タイポグラフィ改善（hint/field-msg/auth-hint/share-hint lh-normal→lh-snug/adv-text h3 lh-normal→lh-tight/pace-msg lh-normal→lh-snug）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
