...
const CACHE_NAME = 'kakeibo-v23.57'; // v23.57: tx-first-col-glow＋tx-col-mem-glow＋tx-month-group-label-glow＋dd-tx-date-glow＋dd-tx-memo-glow＋sb-muted-glow＋sb-nth4-glow＋dow-td4-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
