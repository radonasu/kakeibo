...
const CACHE_NAME = 'kakeibo-v22.38'; // v22.38: CSS品質改善・lh-tighter→lh-snug＋text-wrap補完7要素（pt-widget-total-label・ch-summary-label・dow-stat-label・fv-stat-label・debt-history-title・sim-result-label・ev-sum-label）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
