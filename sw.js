...
const CACHE_NAME = 'kakeibo-v25.37'; // v25.37: sb-banner-num-dark-hover×1+tx-month-group-dark-hover×4+cal-ev-cat-dark-hover×1+ct-stat-value-sub-dark-hover×1+adv-widget-dark-hover×3+yr-unit-dark-hover×2 12箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
