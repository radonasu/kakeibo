...
const CACHE_NAME = 'kakeibo-v24.77'; // v24.77: tx-income-td1/tx-expense-td1/sub-card/forecast-card/wk-widget-card/pace-status-good/warn/over dark mode enhanced inset glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
