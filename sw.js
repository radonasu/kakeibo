...
const CACHE_NAME = 'kakeibo-v24.74'; // v24.74: qa/nt/adv-widget/yr-widget card static inset-top glow完結＋section-tab/tx-th-sort inset-bottom glow＋nav indicator bar glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
