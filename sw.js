...
const CACHE_NAME = 'kakeibo-v22.45'; // v22.45: CSS品質改善・lh-tighter→lh-snug＋text-wrap補完8要素（btn-account-add・btn-sidebar-logout・mobile-title・tx-table・tx-table-td・tx-sort-badge-x・filter-bar-select・filter-search）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
