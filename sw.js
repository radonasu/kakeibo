...
const CACHE_NAME = 'kakeibo-v22.69'; // v22.69: デザイン改善・ch-bar-fillシマー・notif-itemタイプ別glow・wl-archive-itemホバー・wish/pt/sub-widgetカラーglow・dw-itemglow・goal-dash-itemホバー・debt/asset-entryホバー（10箇所）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
