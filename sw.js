...
const CACHE_NAME = 'kakeibo-v15.8.0'; // v15.8.0: animation/transition hardcoded duration CSS変数化完全化（--dur-cycle:2s追加・animation shorthand内.35s/.38s/.22s/.24s/.7s/.12s/2s全15箇所をvar(--dur-*)に変換）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
