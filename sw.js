...
const CACHE_NAME = 'kakeibo-v14.2.0'; // v14.2.0: アニメーション変数システム完全化（--dur-pop/lift/snap/badge/spark/spin/swing/glide/shimmer/gauge・--ease-plain/out/in-out追加・全ease keyword/残存duration値をCSS変数化）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
