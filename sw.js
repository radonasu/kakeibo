...
const CACHE_NAME = 'kakeibo-v23.46'; // v23.46: ct-stat-value-glow＋tg-stat-value-glow＋rc-item-amount-glow＋sub-widget-amount-glow＋ev-widget-amount-glow＋smi-amount-glow＋yi-card-value-glow＋ci-cell-value-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
