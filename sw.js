...
const CACHE_NAME = 'kakeibo-v22.56'; // v22.56: CSS品質改善・lh-tighter→lh-snug補完8要素（cal-ev-badge・sub-cycle-badge・sub-cycle-tag・sub-paused-badge・sub-cycle-unit・yi-card-unit・md-cat-row・md-cat-name）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
