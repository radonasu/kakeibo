...
const CACHE_NAME = 'kakeibo-v19.98'; // v19.98: 数値表示タイポグラフィ改善・letter-spacing/tabular-nums補完（wl-summary-value/ci-score-badge/dd-summary-value/md-cell-value/sb-suggested/qa-amount-input 計6要素）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
