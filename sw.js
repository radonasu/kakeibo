...
const CACHE_NAME = 'kakeibo-v23.63'; // v23.63: ev-widget-cat-glow＋smi-count-glow＋notif-item-body-glow＋debt-entry-date-glow＋debt-entry-note-glow＋ci-cell-label-glow＋pm-sum-sub-glow＋pt-note-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
