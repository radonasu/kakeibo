...
const CACHE_NAME = 'kakeibo-v25.60'; // v25.60: Approach C継続 — dark hover に filter:brightness 追加（section-tab.is-active・type-btn×2・edit/delete/dup-tx×3・ch-status×4・yoy-diff×2 計12箇所）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
