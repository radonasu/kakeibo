...
const CACHE_NAME = 'kakeibo-v24.22'; // v24.22: ev-cat-badge＋wk-cell-label＋asset-sparkline-label＋debt-entry-date＋debt-entry-note＋ci-cell-label＋pm-sum-sub＋tg-stat-label static-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
