...
const CACHE_NAME = 'kakeibo-v22.29'; // v22.29: CSS品質改善・lh-tighter→lh-snug＋text-wrap補完6要素（dup-modal-banner・tx-tag-label-hint・ch-widget-name・ev-widget-cat・sim-savings-label・pm-trend-hint）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
