...
const CACHE_NAME = 'kakeibo-v24.88'; // v24.88: cat-card + pt-card + rc-item + ch-widget-item + debt-widget-item + step-card + asset-entry-row + section-tab hover outer glow dark mode enhanced 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
