...
const CACHE_NAME = 'kakeibo-v23.64'; // v23.64: tg-stat-label-glow＋ct-stat-label-glow＋ct-stat-sub-glow＋yoy-summary-value-glow＋yoy-summary-label-glow＋md-cat-text-glow＋yr-avg-val-glow＋cal-sum-label-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
