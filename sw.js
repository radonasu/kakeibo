...
const CACHE_NAME = 'kakeibo-v24.31'; // v24.31: ev-month-label/ci-event-amount/budget-cat-name/budget-nums/yr-topcat-label/fc-cell-label/yr-cell-label/tx-month-group-summary static-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
