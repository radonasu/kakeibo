...
const CACHE_NAME = 'kakeibo-v24.57'; // v24.57: debt-name/asset-name/pt-card-name/sub-card-name/ci-event-name/opp-title/ch-card-name/debt-widget-name dark-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
