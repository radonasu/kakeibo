...
const CACHE_NAME = 'kakeibo-v24.55'; // v24.55: cat-budget-pct/yr-avg-val/cal-date-num/asset-entry-date/asset-entry-note/md-cell-count-label static-glow + goal-dash-name/amount dark-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
