...
const CACHE_NAME = 'kakeibo-v25.17'; // v25.17: goal-card×7(ring-fill/emoji/deadline/note/pct/sep/progress-bar-fill)+wl-card×5(name/priority-badge/pri-high/medium/low) dark hover 12箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
