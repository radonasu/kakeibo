...
const CACHE_NAME = 'kakeibo-v24.42'; // v24.42: hm-stat-label(type別)/asset-balance-jpy/pt-exp-badge/yr-unit(type別)/dow-table-row-nth3/sub-card-memo/yoy-summary-value/yoy-summary-label static-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
