...
const CACHE_NAME = 'kakeibo-v17.31'; // v17.31: size-deco-s-md(100px)/size-hs-gauge-sm(100px)変数追加＋8箇所変換（summary-card::after/debt-card::before/hs-gauge-sm/hs-grade-badge-mobile）・auth-tab hover状態追加
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
