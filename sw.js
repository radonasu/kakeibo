...
const CACHE_NAME = 'kakeibo-v25.03'; // v25.03: md-cell-label×4 + md-cell-value×2 + wk-cell-value×3 + debt-balance + pt-card-balance + asset-balance dark hover text-shadow 12箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
