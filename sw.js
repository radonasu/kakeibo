...
const CACHE_NAME = 'kakeibo-v22.54'; // v22.54: CSS品質改善・ls-snug→ls-label/ls-fine補完8要素（api-key-status・offline-indicator・debt-history-title・btn-link・sync-user-email-text・stp-config-summary・notif-badge・btn-share）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
