...
const CACHE_NAME = 'kakeibo-v21.05'; // v21.05: タイポグラフィ改善・6要素にfont-variant-numeric:tabular-nums追加（.budget-over-msg/.wk-cell-sub/.pt-widget-exp/.fc-cell-hint/.opp-header-badge/.cc-amount）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
