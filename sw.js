...
const CACHE_NAME = 'kakeibo-v21.39'; // v21.39: タイポグラフィ改善・ls+lh未設定9要素補完（kk-toast-icon/recurring-day-input/fx-currency-label/qa-submit-btn/amt-hist-label・chip/memo-hist-label・chip/tx-added-banner）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
