...
const CACHE_NAME = 'kakeibo-v19.80'; // v19.80: ev-done-cb/sb-check focus-visible追加 + rpt-row-chevron focus-visible連動 + dash-sum-clickable/md-nav-btn focus-visible強化
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
