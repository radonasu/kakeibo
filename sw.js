...
const CACHE_NAME = 'kakeibo-v23.56'; // v23.56: ch-widget-name-glow＋ch-widget-pct-glow＋debt-widget-name-glow＋debt-widget-pct-glow＋goal-dash-name-glow＋goal-dash-pct-glow＋goal-dash-amount-glow＋dow-td2-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
