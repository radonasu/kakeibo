...
const CACHE_NAME = 'kakeibo-v24.92'; // v24.92: qa-type-btn + md-nav-btn + btn-preset + card-collapse-btn + sub-emoji-btn + edit-tx + delete-tx + dup-tx dark hover text-shadow enhanced 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
