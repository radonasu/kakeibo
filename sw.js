...
const CACHE_NAME = 'kakeibo-v22.68'; // v22.68: デザイン改善・fv-stat-cardタイプ別glow・yr-cellホバーglow・hs-itemスライド・goal-ringホバー拡大/glow・yr-widget-cardホバー・fv-cat-tableグロー（10箇所）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
