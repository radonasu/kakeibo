...
const CACHE_NAME = 'kakeibo-v24.44'; // v24.44: ch-progress-label/amt-hist-chip/memo-hist-chip/tx-tag-chip/hs-grade-badge(grade別)/tg-table-text-muted/ct-month-cell/ct-cell-val static-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
