...
const CACHE_NAME = 'kakeibo-v24.86'; // v24.86: pt-widget-item urgent/soon + sub-summary monthly/yearly + pt-total/expiring + ev-sum-this/next hover outer glow dark mode enhanced 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
