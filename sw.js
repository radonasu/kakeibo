...
const CACHE_NAME = 'kakeibo-v23.59'; // v23.59: rpt-month-label-glow＋tg-stat-unit-glow＋ch-card-meta-glow＋opp-desc-glow＋goal-deadline-glow＋goal-note-glow＋hs-score-unit-glow＋goal-achieved-date-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
