...
const CACHE_NAME = 'kakeibo-v22.31'; // v22.31: CSS品質改善・lh-tighter→lh-snug＋text-wrap補完6要素（hs-item-label・qa-card-title・qa-subtext・notif-panel-footer・notif-empty-sub・dd-summary-label）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
