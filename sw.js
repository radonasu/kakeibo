...
const CACHE_NAME = 'kakeibo-v21.01'; // v21.01: タイポグラフィ改善・4要素にfont-variant-numeric:tabular-nums追加（.nt-char-count/.cal-date-num/.cal-ev-count/.bulk-count）＋.cal-ev-count lh-tight→lh-tighter修正
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
