...
const CACHE_NAME = 'kakeibo-v24.24'; // v24.24: ev-sum-label＋pt-summary-label＋ch-sum-achieved-label＋ch-sum-active-label＋ch-sum-total-label＋sub-summary-label＋wl-sum-done-label＋step-action static-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
