...
const CACHE_NAME = 'kakeibo-v25.21'; // v25.21: yi-card×5(card-sub/sub-muted/card-unit/grade-badge/card-value-cat)+dd-summary-value+hm-stat-sub+pace-bar×5(fill/good/warn/over/pct) dark hover 12箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
