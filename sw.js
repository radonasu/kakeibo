...
const CACHE_NAME = 'kakeibo-v24.40'; // v24.40: ev-mtot(type別)/md-cat-amount(type別)/md-cat-pct/cal-ev-cat/cat-yayoi-tag/step-desc/fv-rate-badge(type別) static-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
