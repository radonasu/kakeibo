...
const CACHE_NAME = 'kakeibo-v25.25'; // v25.25: widget-icon-dark-hover×6+wish-widget-text-dark-hover×2+ch-widget-text-dark-hover×2+sub-card-color-bar-dark-hover×1+pm-sum-icon-dark-hover×1 12箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
