...
const CACHE_NAME = 'kakeibo-v24.73'; // v24.73: tx-income/expense-td1・fc-alert-anim・sub-card static inset-left glow完結＋forecast/wk-widget/pace-status inset-top glow＋sim-loan-info 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
