...
const CACHE_NAME = 'kakeibo-v23.47'; // v23.47: pm-sum-label-glow＋yr-cell-label-glow＋hm-stat-unit-glow＋yr-topcat-label-glow＋dd-summary-label-glow＋fc-cell-label-glow＋insight-title-glow＋sub-cycle-unit-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
