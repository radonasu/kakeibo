...
const CACHE_NAME = 'kakeibo-v22.44'; // v22.44: CSS品質改善・lh-tighter→lh-snug＋text-wrap補完8要素（nav-item・btn-link・cat-chip・tx-tag-filter-label・ev-done-label・sf-save-btn・ci-cell-label・ci-section-title）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
