...
const CACHE_NAME = 'kakeibo-v22.52'; // v22.52: CSS品質改善・ls-snug→ls-label補完8要素（smi-filter-badge・cat-badge・modal-details-summary・step-action・hs-prev-badge・pace-status-badge・amt-hist-chip・memo-hist-chip）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
