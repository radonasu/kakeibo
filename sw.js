...
const CACHE_NAME = 'kakeibo-v22.77'; // v22.77: デザイン改善・pace-daily-cellホバーglow・md-cell-countホバー・sub-card-icon/opp-iconスケール・step-numポップ・dd-summary-itemホバー・yi-card border-colorトランジション・asset-type-badgeホバー（8箇所）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
