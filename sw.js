...
const CACHE_NAME = 'kakeibo-v24.63'; // v24.63: sub-summary-amount/pt-summary-amount/ch-sum-achieved|active|total-value/wl-sum-done-value/hs-item-label/pm-table-row-td1 dark-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
