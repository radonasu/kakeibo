...
const CACHE_NAME = 'kakeibo-v23.83'; // v23.83: ci-badge-failed/ct-table-text-muted/wk-today-label/sb-low-data/hs-grade-badge/hs-spark-label/hs-spark-label-now/debt-rate-monthly-badge に text-shadow glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
