...
const CACHE_NAME = 'kakeibo-v23.88'; // v23.88: btn-primary/hamburger/edit-tx/delete-tx/dup-tx/sub-emoji-btn/btn-continue/install-banner-close に text-shadow glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
