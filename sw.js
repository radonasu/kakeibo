...
const CACHE_NAME = 'kakeibo-v23.58'; // v23.58: fv-cat-first-col-glow＋smi-label-glow＋smi-amount-glow＋dd-summary-label-glow＋hm-stat-unit-glow＋rc-item-amount-glow＋section-tab-glow＋sub-cycle-unit-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
