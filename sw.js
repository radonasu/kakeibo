...
const CACHE_NAME = 'kakeibo-v23.51'; // v23.51: wl-archive-date-glow＋ct-chip-name-glow＋pace-daily-label-glow＋md-cell-label-glow＋yi-half-label-glow＋wk-unit-glow＋insight-desc-glow＋ev-mtot-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
