...
const CACHE_NAME = 'kakeibo-v25.48'; // v25.48: debt-summary-sub×2+debt-summary-label×2+sb-banner-lbl+ch-sum-unit×2+pt-summary-amount+sub+unit×3+pt-total/expiring-label×2 dark hover 12箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
