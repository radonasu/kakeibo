...
const CACHE_NAME = 'kakeibo-v24.60'; // v24.60: nav-item-not-active/btn-account-add/ev-sum-count-small/btn-notif-bell/ci-ok-btn/ev-add-month/tx-tag-filter-chip-not-active/onboarding-cta dark-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
