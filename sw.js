...
const CACHE_NAME = 'kakeibo-v21.71'; // v21.71: タイポグラフィ改善・tabular-nums補完7要素（hs-item-score・hs-item-max・debt-balance-meta・debt-progress-label・debt-end-pill・debt-entry-date・debt-history-more）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
