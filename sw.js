...
const CACHE_NAME = 'kakeibo-v24.41'; // v24.41: ev-card-amount/ev-prog-pct/rc-item-meta/cat-chip-name/hs-item-max/dow-pct(type別)/sub-cycle-tag/pt-card-yen static-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
