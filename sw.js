...
const CACHE_NAME = 'kakeibo-v25.07'; // v25.07: yr-cell-savings-warn/danger label×2・yr-cell-savings unit×3・yr-cell-savings sub×3・yr-cell-savings prev-badge×3 dark hover text-shadow 11箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
