...
const CACHE_NAME = 'kakeibo-v22.84'; // v22.84: デザイン改善・ホバー時数値brightness+color強化 8箇所（summary-amount/hm-stat-value/yr-cell-value/tx-table-amount/rpt-month-td/fv-stat-value/dow-stat-amount/pt-card-balance）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
