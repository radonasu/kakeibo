...
const CACHE_NAME = 'kakeibo-v24.33'; // v24.33: yr-avg-label/budget-sep/pt-card-pt-unit/ev-done-label/debt-history-title/asset-history-title/tg-table-first-col/step-title static-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
