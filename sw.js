...
const CACHE_NAME = 'kakeibo-v15.9.0'; // v15.9.0: グローバルCSS微細改善（::selection ブランドカラー選択ハイライト・-moz-osx-font-smoothing grayscale・--fs-icon-2-5xl:32px追加・font-size:2rem→CSS変数化）
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
