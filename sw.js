...
const CACHE_NAME = 'kakeibo-v23.71'; // v23.71: insight-title-glow+insight-desc-glow+md-cell-label-glow+md-cell-value-glow+sim-savings-label-glow+step-action-glow+wl-card-meta-glow+debt-progress-hdr-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
