...
const CACHE_NAME = 'kakeibo-v24.45'; // v24.45: modal-close/adv-filter-toggle/adv-filter-clear/goal-emoji-btn/ev-emoji-chip/pt-emoji-btn/ch-emoji-btn/rc-close static-glow 8箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
