...
const CACHE_NAME = 'kakeibo-v25.20'; // v25.20: asset-card×7(balance-jpy/currency-badge/fx-rate/foreign-hint/sparkline-wrap/sparkline-label/history-title) dark hover 7箇所
const ASSETS = [
  './index.html',
  './css/style.css',
  './js/icons.js',
